...
export const LEAVE_AMEND_BODY = {
  ...
  schema: {
    ...
    properties: {
      ...
      p_leave_to_amend: { type: 'string', example: '56944958', description: 'Leave-record id from the amend LOV (op 62, GET /leave/lov/amend) — NOT a small ordinal.' },
      p_new_end_date: {
        type: 'string',
        example: '2026-06-20',
...
export const LEAVE_CANCEL_BODY = {
  ...
  schema: {
    ...
    properties: {
      p_leave_type: { type: 'string', example: 'Annual Leave' },
      p_leave_to_cancel: { type: 'string', example: '56944958', description: 'Leave-record id from the cancel LOV (op 61, GET /leave/lov/cancel) — NOT a small ordinal.' },
...
export const LEAVE_RETURN_BODY = {
  ...
  schema: {
    ...
    properties: {
      p_leave_details: {
        type: 'string',
        example: 'Casual Leave|Leave Start Date : 19-APR-2026 and Leave End Date : 19-APR-2026',
        description: 'FULL value string from the return LOV (op 55, GET /leave/lov/return → used_value).',
      },
      p_related_leave1: { type: 'string', example: '' },
      p_related_leave2: { type: 'string', example: '' },
      p_return_date: { type: 'string', example: '20-Apr-2026', description: 'Return date (DD-Mon-YYYY).' },
      p_comments: { type: 'string', example: 'Returned early.' },
      ...attachmentProperties(),
    },
    example: {
      p_leave_details: 'Casual Leave|Leave Start Date : 19-APR-2026 and Leave End Date : 19-APR-2026',
