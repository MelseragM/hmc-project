...
import { SubmitTicketRequestDto } from './dto/annual-ticket.dto';
...
export class AnnualTicketController {
  ...
  async master(@Query() q: LangQueryDto): Promise<LovResponseDto> {
    return { items: await this.service.master(q.lang) };
  }
  ...
  apply(
    @Body() dto: SubmitTicketRequestDto,
